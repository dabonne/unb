...
class Annonce
{
     ...
     * @var string
     */
    private $fichannonces;

    /**
     * @Vich\UploadableField(mapping="annonces_fichannonces",  fileNameProperty="fichannonces")
     * @var File
     */
    private $fichannoncesFile;

    public function setFichannoncesFile( File $fichannonces = null)
    {
        $this->fichdiplomesFile = $fichannonces;
    ...
    public function getFichannoncesFile()
    {
        return $this->fichannoncesFile;
    }
     ...
     * Set fichannonces
     *
     * @param string $fichannonces
     *
     * @return Annonce
     */
    public function setFichannonces($fichannonces)
    {
        $this->fichannonces = $fichannonces;
     ...
     * @return string
     */
    public function getFichannonces()
    {
        return $this->fichannonces;
    }
}
